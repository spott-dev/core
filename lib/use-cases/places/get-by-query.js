 ...
 * @param {string} params.query - String to search for matching places
 * @param {string} params.searchMethod - Type of search to get results. Valid ones are: SIMPLE and AUTOCOMPLETE
...
function getPlacesByQuery(params) {
  ...
  const execute = async () => {
    ...
    return populateIndexedPlaces({ database, languages, indexedPlaces });
  };
